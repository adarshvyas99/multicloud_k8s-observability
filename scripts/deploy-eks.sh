...
# Kubernetes Observability Stack Deployment Script for EKS
# This script deploys Prometheus, Grafana, and AlertManager to Amazon Elastic Kubernetes Service

set -e

echo "🚀 Starting Kubernetes Observability Stack deployment for EKS..."
...
echo "🔧 Configuring storage class for EKS..."
