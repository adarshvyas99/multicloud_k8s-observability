...
# Kubernetes Observability Stack Deployment Script for AKS
# This script deploys Prometheus, Grafana, and AlertManager to Azure Kubernetes Service

set -e

echo "🚀 Starting Kubernetes Observability Stack deployment for AKS..."
...
echo "🔧 Configuring storage class for AKS..."
